    ...
    >
      ...
      >
        ...
        <div className=" bottom-20 max-lg:bottom-10 left-20 max-lg:left-10 z-50">
          <a
            href="/about"
            className="relative group px-8 py-3 bg-red-500 text-white hover:text-white rounded-full
             text-sm overflow-hidden transition"
          >
            <span className="relative z-10">Know More</span>

            <span
              className=" absolute bottom-0 left-1/2 w-0 h-0 rounded-3xl bg-black 
